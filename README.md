...
- **Relational & Graph SQLite Database (`backend/topology.db`):**
  ...
  - **`relationships` Table:** Stores 1,659 directional relationships (`source_id`, `source_type`, `target_id`, `target_type`, `rel_type`) mapping connections between Concepts-to-Concepts, Theorems-to-Theorems, and Concepts-to-Theorems from `RelatedConcepts` and `RelatedTheorems` associations.
